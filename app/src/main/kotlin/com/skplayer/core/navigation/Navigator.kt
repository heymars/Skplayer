 ...
 */
package com.skplayer.core.navigation
...
import com.skplayer.features.login.Authenticator
import com.skplayer.features.login.LoginActivity
import com.skplayer.features.movies.MovieDetailsActivity
import com.skplayer.features.movies.MovieView
import com.skplayer.features.movies.MoviesActivity
import com.skplayer.core.extension.empty
import com.skplayer.features.player.FolderActivity
import com.skplayer.features.player.FolderFragment
import com.skplayer.features.player.PlayerActivity
...
@Inject constructor(private val authenticator: Authenticator) {
    ...
    fun openFoler(context: Context) = context.startActivity(FolderActivity.callingIntent(context))

    fun openPlayer(activity: FragmentActivity, videoUrl: String){
        val intent = PlayerActivity.callingIntent(activity, videoUrl)
        activity.startActivity(intent)
    }

    fun showFragment(activity: Activity, fragment: Fragment, containerId: Int, addToBackStack: Boolean) {
