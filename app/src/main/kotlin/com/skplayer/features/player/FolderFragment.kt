 ...
 */
class FolderFragment : BaseFragment(), FolderListAdapter.ClickListener{
    ...
    override fun layoutId() = R.layout.fragment_folder
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        folderlistAdapter = FolderListAdapter(requireActivity(),FileUtils.getDocumentList(),this)
        val layoutManager = LinearLayoutManager(requireContext())
        recyclerView.layoutManager = layoutManager as RecyclerView.LayoutManager?
        recyclerView.adapter = folderlistAdapter
    }

    override fun onItemClick(videoPath: String) {
      navigator.openPlayer(activity = requireActivity(), videoUrl = videoPath)
    }
    ...
    interface OnFragmentInteractionListener {
        ...
        fun openPlayerFragment(videoPath:String)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): FolderFragment {
